...
<div style="padding: 10px">
    <%
        ...
        where += " AND goupiaoren='" + request.getSession().getAttribute("username") + "' "; //  设置goupiaoren为当前登录用户
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_yanyichangsuo3"
                        ...
                        <script>
                            $(".class_yanyichangsuo3").val($(".class_yanyichangsuo3").attr("data-value"))</script>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_zhuangtai4"
                        ...
                        <script>
                            $(".class_zhuangtai4").val($(".class_zhuangtai4").attr("data-value"))</script>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapyanyiting2 = new CommDAO().find("SELECT mingcheng FROM yanyiting where id='" + map.get("yanyichangsuo") + "'");
                        %><%= mapyanyiting2.get("mingcheng") %>
                        </td>
                        ...
                        <td align="center">
                            ...
                            <%
                                if (map.get("zhuangtai").equals("已出票")) {
                            %>
                            <a href="tuipiao_add.jsp?id=<%= map.get("id") %>">退票</a>
                            ...
                            <%
                                if (map.get("zhuangtai").equals("已出票")) {
                            %>
                            <a href="pingjia_add.jsp?id=<%= map.get("id") %>">评价</a>
