...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="huajuxinxi.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
...
<% } %>
    ...
    <input type="text" class="form-control" id="haibao" name="haibao" value=""/>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" id="zhuyan" name="zhuyan" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" id="shizhang" name="shizhang" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
