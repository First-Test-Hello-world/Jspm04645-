...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
            ...
            List<HashMap> list = Query.make("yanyiting").where(where).order(orderby+" "+sort).page(15);
...
<td> <%= map.get("jilie") %> </td>
                        ...
                        <td align="center">
                                                                                    ...
                                                                                    <a href="yanyiting_updt.jsp?id=<%= map.get("id") %>">修改</a>
                            <a href="yanyiting.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a>
                            <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
