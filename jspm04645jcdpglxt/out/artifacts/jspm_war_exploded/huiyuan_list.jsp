...
<div style="padding: 10px">
    <%
        ...
        if (session.getAttribute("cx").equals("会员")) {

            where += " AND yonghuming='" + session.getAttribute("yonghuming") + "' ";
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="" name="yonghuming"
                               value="<%= request.getParameter("yonghuming") !=null ? request.getParameter("yonghuming") : "" %>"/>
                    </div>
                    <div class="form-group">
                        姓名
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="" name="shouji"
                               value="<%= request.getParameter("shouji") !=null ? request.getParameter("shouji") : "" %>"/>
                    </div>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><% if ("".equals(map.get("touxiang"))) { %>-<% } else { %><img width="100"
                                                                                           src="<%= map.get("touxiang") %>"/><% } %>
                        </td>
                        ...
                        <td align="center">
                            ...
                            <a href="huiyuan.jsp?a=delete&id=<%= map.get("id") %>"
