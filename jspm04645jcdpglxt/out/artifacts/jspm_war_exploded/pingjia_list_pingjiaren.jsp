...
<div style="padding: 10px">
    <%
        ...
        where += " AND pingjiaren='" + request.getSession().getAttribute("username") + "' "; //  设置pingjiaren为当前登录用户
...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
        ...
        if (request.getParameter("pingfen") != null && !"".equals(request.getParameter("pingfen"))) {
            where += " AND pingfen ='" + request.getParameter("pingfen") + "'";
        }
        if (request.getParameter("pingyu") != null && !"".equals(request.getParameter("pingyu"))) {
            where += " AND pingyu LIKE '%" + request.getParameter("pingyu") + "%'";
        }
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_pingfen20"
                                data-value="<%= request.getParameter("pingfen") !=null ? request.getParameter("pingfen") : "" %>"
                                id="pingfen" name="pingfen">
                        ...
                        <script>
                            $(".class_pingfen20").val($(".class_pingfen20").attr("data-value"))</script>

                    </div>
                    <div class="form-group">
                        评语

                        <input type="text" class="form-control" id="pingyu" name="pingyu"
                               value="<%= request.getParameter("pingyu") !=null ? request.getParameter("pingyu") : "" %>"/>
                    </div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td align="center">
                            ...
                            <a href="pingjia.jsp?a=delete&id=<%= map.get("id") %>"
