...
<%
    ...
    HashMap mmm = new CommDAO().getmap(request.getParameter("id") , "tuipiao");
    %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="tuipiao.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <% 
 HashMap mapyanyiting25 = new CommDAO().find("SELECT mingcheng FROM yanyiting where id='"+mmm.get("yanyichangsuo")+"'"); 
 %><%= mapyanyiting25.get("mingcheng") %><input type="hidden" id="yanyichangsuo" name="yanyichangsuo" value="<%= Info.html(mmm.get("yanyichangsuo")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" id="tuipiaoyuanyin" name="tuipiaoyuanyin"><%= Info.html(mmm.get("tuipiaoyuanyin")) %></textarea>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="number" class="form-control" style="width:150px;" number="true" data-msg-number="输入一个有效数字" min="1" max="<%= readMap.get("goumaipiaoshu") %>" id="tuipiaozhangshu" name="tuipiaozhangshu" value="<%= Info.html(mmm.get("tuipiaozhangshu")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="tuipiaoren" name="tuipiaoren" value="<%= mmm.get("tuipiaoren") %>"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
