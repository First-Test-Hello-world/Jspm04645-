...
<%
    ...
    {
        new CommDAO().commOper("update goupiao set zhuangtai='已出票' where id='"+order.get("id")+"'");

new CommDAO().commOper("update changci set shengyupiaoshu=shengyupiaoshu-'"+order.get("goumaipiaoshu")+"' where id='"+order.get("changciid")+"'");
