    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ac.equals("login")) {
            ...
            if (!pagerandom.equals(random) && request.getParameter("a") != null) {
                ...
                String sql1 = "";
                                                                if (utype.equals("会员")) {
                                        sql1 = "select * from huiyuan where yonghuming='" + username + "' and mima='" + password + "' ";
                }
        ...
        if (ac.equals("adminuppass")) {
            ...
            String biao = "";
                ...
                // dao.getmaps("yonghuming", (String) request.getSession().getAttribute("username"), "huiyuan");
                            }
            ...
            if (m == null || m.isEmpty()) {
                ...
                String sql = "";
                    ...
                    sql = "UPDATE admins SET pwd='"+userpass+"' WHERE username='"+username+"'";
                                ...
                                if(cx.equals("会员")){
                    sql = "UPDATE huiyuan SET mima='"+userpass+"' WHERE yonghuming='"+username+"'";
                }
