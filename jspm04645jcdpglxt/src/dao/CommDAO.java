    ...
    public Connection getConn() {
        try {
            if (conn == null || conn.isClosed()) {
			        	 ...
			        	 conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jspm04645jcdpglxt?useUnicode=true&characterEncoding=UTF-8&useOldAliasMetadataBehavior=true","root","root");
			        	 // mysql 8.0 以上使用
			        	 //Class.forName("com.mysql.cj.jdbc.Driver"); 
			        	 //conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jspm04645jcdpglxt?useUnicode=true&characterEncoding=UTF-8&useSSL=FALSE&serverTimezone=UTC&useOldAliasMetadataBehavior=true","root","root");
